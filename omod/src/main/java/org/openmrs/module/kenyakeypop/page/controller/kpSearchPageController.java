...
public class kpSearchPageController {
	
	public String controller(UiUtils ui, @RequestParam(required = false, value = "seenDate") Date seenDate, PageModel model) {
		...
		if (patient != null) {
			return "redirect:"
			        + ui.pageLink(EmrConstants.MODULE_ID, "clinician/clinicianHome",
